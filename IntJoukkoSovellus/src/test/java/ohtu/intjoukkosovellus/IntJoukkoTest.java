...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.lukuTaulukossa(10));
        assertFalse(joukko.lukuTaulukossa(5));
        assertTrue(joukko.lukuTaulukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.lukuTaulukossa(3));
    ...
    public void palautetaanOikeaTaulukko() {
        ...
        int[] vastaus = joukko.luoTaulukko();
        Arrays.sort(vastaus);
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.lukuTaulukossa(11));
        joukko.poista(11);
        assertFalse(joukko.lukuTaulukossa(11));
